			...
			<div class="login-container">
				<div>
					<div class="member-join">
						...
						<label for="">이메일 :<input type="text" size="20" id="email" name="email"
							maxlength="20" class="id" placeholder="이메일을 입력해주세요" /></label> <span
							class="email"></span>
					</div>
					<div>
						<label for="">이름 : <input type="text" id="nameck" name="nameck"
							class="id" size="20" maxlength="10" placeholder="이름을 입력해 주세요" /></label>
						<span class="name"></span>
					</div>
					<div>
						<label for="">비밀번호: <input type="password" id="pwd" name="pwd"
					...
					<div>
						<label for="">사용할 아이디:<input type="text" id="usernic" name="usernic"
